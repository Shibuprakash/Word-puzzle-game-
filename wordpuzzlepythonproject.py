...
occupied = dict()
allwords = ["spider","snake","panda","love","sweetheart","light"]
'''c.pack()
scores = tkinter.Label(root, textvariable=score)
scores.pack()

'''
l9=tkinter.Label(root,text="word puzzle game")
l9.configure(font=("Times New Roman",40,"bold"))
l9.pack()

scores = tkinter.Label(root, textvariable=score)
scores.configure(font=("Times New Roman",20,"bold"))
scores.pack()

words = tkinter.Label(root, textvariable=gotwords)
words.configure(font=("Times New Roman",14,"bold"))
words.pack()
...
l=tkinter.Label(root,text="hint:")

l1=tkinter.Label(root,text="1.the animal that releases web.    2.reptile which makes hss.... sound.   3.the animal that likes bamboo.")
l1.pack()

l2=tkinter.Label(root,text="4.it's a beautiful feeling.    5.shavdhzvdhmduy.   6.dsjdfkzskyzds.")
l2.pack()
root.mainloop()
